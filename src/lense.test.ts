...
tap.test('constructor', (t:any) => {
    ...
    t.equals(root_lense.field(form0), form0.root, 'root_lense.field return root field')
    t.equals(root_lense.value(initial_value), initial_value, 'root_lense.value return initial_value')

    t.equals(bar0.field(form0), form0.root.children.nested.children[0].children.bar, 'arbitrary path found in form')
